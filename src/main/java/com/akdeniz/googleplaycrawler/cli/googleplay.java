...
public class googleplay {
    ...
    public List<String> downloadPermissionsList(String[] argv) throws Exception {
        parseArgs(argv);
        return permissionsCommand();
    }

//    public List<String> downloadPermissionsList(String email, String password,String androidID) throws Exception {
//
//        parseArgs(new String []{email, password, androidID});
//        return permissionsCommand();
//    }
    ...
    private List<String> permissionsCommand() throws Exception {
        login();
        String aPackage = (String) namespace.getList("package").get(0);
        return getPermissionsForPackage(aPackage);
    }

    public List<String> getPermissionsForPackage(String packageName) throws IOException {
        ...
        for (Iterator<String> iterator = appDetails.getPermissionList().iterator(); iterator.hasNext(); ) {
